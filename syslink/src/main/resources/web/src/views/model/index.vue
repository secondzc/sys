<template >
    ...
    <el-container style="border: 1px solid #eee">
        <el-aside width="300px" style="background-color: rgb(238, 241, 246);border: 1px solid #B0C4DE">
          <!--模型分类树-->
          <!--<div style="border: 2px solid #9E9E9E;margin-top: 20px;padding: 10px">-->
          <kz-tree :data="tree" @node-click="hanldeNodeClick" style="min-height: -webkit-fill-available"></kz-tree>
          <!--</div>-->
        </el-aside>
                   ...
                   <el-col :span="12" >
                      <div style="display: inline-block;"  id="sortMoudle">
                       ...
                       <div style="display: none;"  id="modelNumb">
                           <div style="font-size:19px;" v-if="{amsg} == 0">
                               总共有个{{modelTotal}}模型库
                           </div>
                           <div v-else style="font-size:19px;">
              ...
              <!--<div style="height: 30px;display: inline-block;float: right;margin-right: 20px">-->
                   <el-col :span="3" :offset="1">
                       ...
                       <div class="btn-group os-button-group">
                           ...
                           <label @click="switchList" data-original-title="Grid view" class="btn btn-default ng-untouched ng-valid ng-not-empty ng-dirty" uib-btn-radio="viewModes.GRID" >
